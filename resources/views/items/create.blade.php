            ...
            <div class="card-body p-4">
                <form action="{{ route('items.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror" value="{{ old('sku') }}" placeholder="Contoh: KRT-A4-70G" required>
                        @error('sku')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: Kertas HVS A4 70 Gram" required>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">Stok Sistem <span class="text-danger">*</span></label>
                        <input type="number" name="system_stock" class="form-control @error('system_stock') is-invalid @enderror" value="{{ old('system_stock') }}" min="0" placeholder="Contoh: 150" required>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">Alokasi Rak (Opsional)</label>
                        <select name="rack_id" id="rackSelect" class="form-select @error('rack_id') is-invalid @enderror">
                        ...
                        <div class="form-text text-muted">Anda bisa mengalokasikan rak nanti.</div>
                        @error('rack_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
